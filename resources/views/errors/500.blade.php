        ...
        <div class="container">
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149" />
                            ...
                            <g id="spaceman" clip-path="url(cordClip)">
                                <path id="cord" fill="none" stroke="#FFFFFF" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z" />
                                <g id="antenna">
                                    <line fill="#FFFFFF" stroke="#FFFFFF" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="323.396" y1="236.625" x2="295.285" y2="353.753" />
                                    <circle fill="#FFFFFF" stroke="#FFFFFF" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" cx="323.666" cy="235.617" r="6.375" />
                                </g>
                                <g id="armR">
                ...
                <div class="col-md-6 align-self-center">
                    <h1>500</h1>
                    <h2>UPSS! ESTAMOS TRABAJANDO EN ESTE ERROR</h2>
                    <p>
                        Puedes hacer clic en el botón de abajo
                        para volver a la página de inicio.
                    </p>
                    <a class="btn green" href="{{url('/Anuncios')}}">INICIO</a>
                </div>
            </div>
        </div>
    </main>
    <script src="{{ url('js/appError.js') }}"></script>
</body>
