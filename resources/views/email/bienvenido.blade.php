                                ...
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="88999" align="center">
                                        <table class="es-header-body" style="background-color: #ffffff;" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p10t es-p10b es-p40r es-p40l" align="left" bgcolor="#000000" style="background-color: #000000;">
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="520" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image" align="center" style="font-size: 0px;"><a href="https://viewstripo.email/" target="_blank"><img src="https://demo.stripocdn.email/content/guids/56ee529b-d890-4776-81e3-10b166836a49/images/image.png" alt style="display: block;" width="267"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p40t es-p10b">
                                                                                        <h1 style="color: #ffffff;">Bienvenido {{$details['name']}}</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td esdev-links-color="#ffffff" class="esd-block-text es-p10t es-p20b es-p30r es-p30l" align="center">
                                                                                        <p style="color: #ffffff;">Es un gusto que ya estes con nosotros,Antes que todo deberás crear tu contraseña.</p>
                                                                                        <br />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p10t es-p20b" align="center"><span class="es-button-border" style="border-width:1px 1px 1px 1px;border-radius:50px;background:#bf9000;padding:15px;color:#ffffff;text-decoration:none"><a href="{{$details['resetUrl']}}" class="es-button" target="_blank" style="border-width:1px 1px 1px 1px;border-radius:50px;background:#bf9000;padding:15px;color:#ffffff;text-decoration:none">CREAR</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p5t es-p15b es-m-txt-c" align="left">
                                                                                        <h2>TU CUENTA YA ESTA ACTIVA</h2>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b" align="left">
                                                                                        <table border="1" cellpadding="5px" style="border-collapse:collapse">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td width="30%" style="color:#bf9000"><b>NOMBRE</b></td>
                                                                                                    <td width="70%" style="color:#000000">{{$details['name']}}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td width="30%" style="color:#bf9000"><b>DOCUMENTO</b></td>
                                                                                                    <td width="70%" style="color:#000000">{{$details['document']}}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td width="30%" style="color:#bf9000"><b>TELEFONO</b></td>
                                                                                                    <td width="70%" style="color:#000000">{{$details['phone']}}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td width="30%" style="color:#bf9000"><b>EMAIL</b></td>
                                                                                                    <td width="70%" style="color:#000000">{{$details['email']}}</td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                            ...
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="7392" align="center">
                                        <table class="es-content-body" style="background-color: #000000;" width="600" cellspacing="0" cellpadding="0" bgcolor="#26a4d3" align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p40t es-p20b es-p40r es-p40l" style="background-color: #000000;" bgcolor="#26a4d3" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="520" valign="top" align="center">
