                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td esdev-links-color="#ffffff" class="esd-block-text es-p10t es-p20b es-p30r es-p30l" align="center">
                                                                                        <p style="color: #ffffff;">Nuevo mensaje</p>
                                                                                        <br />
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10b" align="left">
                                                                                        <p>Hemos recibido tu mensaje, muy pronto te responderemos.</p>
                                                                                        <p>Tus datos:</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b" align="left">
                                                                                        <table border="1" cellpadding="5px" style="border-collapse:collapse">
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td width="30%" style="color:#bf9000"><b>ASUNTO</b></td>
                                                                                                    <td width="70%" style="color:#000000">{{$details['subject']}}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td width="30%" style="color:#bf9000"><b>MENSAJE</b></td>
                                                                                                    <td width="70%" style="color:#000000">{{$details['message']}}</td>
                                                                                                </tr>
                                                                                                <tr>
