                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p40t es-p10b">
                                                                                        <h1 style="color: #ffffff;">Hola {{$details['name']}} </h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td esdev-links-color="#ffffff" class="esd-block-text es-p10t es-p20b es-p30r es-p30l" align="center">
                                                                                        <p style="color: #ffffff;">Ha solicitado un restablecimiento de contraseña para su cuenta de ConjuntoMIO. Siga el siguiente enlace para establecer una nueva contraseña:</p>
                                                                                        <br />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p10t es-p20b" align="center"><span class="es-button-border" style="border-width:1px 1px 1px 1px;border-radius:50px;background:#bf9000;padding:15px;color:#ffffff;text-decoration:none"><a href="{{$details['resetUrl']}}" class="es-button" target="_blank" style="border-width:1px 1px 1px 1px;border-radius:50px;background:#bf9000;padding:15px;color:#ffffff;text-decoration:none">CAMBIALA AQUÍ</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
