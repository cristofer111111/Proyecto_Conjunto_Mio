...
@section('content')
<main class="mainForm">
        <form action="{{route('Visitantes.store')}}" enctype="multipart/form-data" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" required class="form-control" name="cedula" placeholder="Número de Identidad">
                @error('cedula')
                <div class="invalid">
                    {{$message}}
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" required class="form-control" name="telefono" placeholder="Telefono">
                @error('telefono')
                <div class="invalid">
                    {{$message}}
                </div>
            ...
            <br>
            <button class="btn btn-light">Guardar</button> <a href="{{url('Visitantes')}}" class="btn btn-dark"> Cancelar</a>
        </form>
</main>
@endsection
