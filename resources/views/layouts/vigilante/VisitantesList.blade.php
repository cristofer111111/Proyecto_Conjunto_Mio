...
<main>
    ...
    <div class="container ">
        ...
        <div class="row">
            ...
            <div class="col-2">
                <a href="{{url('Visitantes/ReportePdf')}}" class="btn btn-light awidth">Generar PDF
                </a>
            </div>
            <div class="col-2">
                <a href="{{url('Visitantes/create')}}" class="button button--hyperion"><span><span>Crear</span></span>
                </a>
            </div>
        </div>
    </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('Visitantes.marcarSalida',$visitante->id)}}" method="post">
                                    @csrf
                                    <a href="{{route('Visitantes.notificarResidente',$visitante->id)}}" class="btn btn-sm btn-light">Notificar</a>
